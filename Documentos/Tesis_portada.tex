...
\vspace*{0.4in}
\begin{Large}
%\textbf{EL TITULO MUY CHEVERÉ PARA LA TESIS,} \\
\textsc{\textbf{Influencia de la racionalidad en un modelo un financiero con elementos microscópicos.}}\\
%\textbf{Simulación mediante librerías de Python de un modelo financiero para diferentes niveles de racionalidad}\\
\end{Large}
\vspace*{0.2in}
